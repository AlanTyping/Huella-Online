...
export function Philosophy() {
  return (
    <section id="filosofia" className="bg-brand-primary-deep py-24 lg:py-32 border-t border-white/[0.03]">
          ...
          >
            ...
            <div className="mt-12 space-y-10">
              <div className="group flex gap-6">
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-md bg-white/5 border border-white/10 text-brand-secondary transition-transform group-hover:scale-110">
                  <Fingerprint className="h-8 w-8" />
                </div>
                <div>
                  <h3 className="text-2xl font-black tracking-tight text-white uppercase">Identidad Pura</h3>
