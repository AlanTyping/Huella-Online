    ...
    <div className={cn("flex items-center gap-3", className)}>
      <div className="relative flex h-10 w-10 items-center justify-center">
        ...
        >
          ...
          <rect x="18" y="28" width="4" height="8" rx="1" fill="var(--brand-orange)" />
          <circle cx="20" cy="15" r="3" fill="var(--brand-orange)" />
          <circle cx="14" cy="12" r="1.5" fill="var(--brand-orange)" opacity="0.8" />
